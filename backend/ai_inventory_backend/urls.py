...
urlpatterns = [
    ...
    path('api/', include('inventory.urls')),  # Inventory-related endpoints
    ...
    re_path(r'^.*$', TemplateView.as_view(template_name='index.html'), name='index'),  # Handle all frontend routes
